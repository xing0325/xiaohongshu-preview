...
- 最后一张图：用卡片化方式强化同一个记忆点，例如“18 岁休学 vibe coder，一边做项目一边记录 AI 工作流”。

这个签名不要写成硬广，也不要每篇都大段自我介绍。它的作用是让读者下次刷到时能想起：哦，原来还是这个人在做这些项目。
...
6. 最后一页必须给“账号记忆点”：用一句人话介绍我是谁、这个账号长期记录什么，并给出关注理由；同时给明确行动入口：看仓库、试用、评论区自取、复刻步骤等。
